...
```sh
git clone https://github.com/nickjj/docker-django-example saludarte
cd saludarte
...
The app is named `saludarte` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "saludarte" and update a few Docker related resources.
